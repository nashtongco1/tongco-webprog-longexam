  ...
  return (
    <>
      ...
      <form className="mt-8 space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 text-sm">
          <label className="flex items-center gap-2 text-purple-600">
            <input type="checkbox" className="h-4 w-4 rounded border-purple-300 accent-purple-900" />
            <span>Remember me</span>
          </label>
          <button type="button" className="font-medium text-purple-700 transition hover:text-purple-900">
            Forgot Password?
          </button>
        </div>
      ...
      <div className="mt-8 border-t border-purple-200 pt-6 text-sm text-purple-600">
        No account yet?{' '}
        <Link to="/auth/signup" className="font-semibold text-purple-900 transition hover:text-purple-600">
          Sign Up
        </Link>
      </div>
    </>
